(module
 ...
 (table 9 9 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN9ednatoken11setoverflowEy $_ZN9ednatoken8addbonusEyN5eosio5assetE $_ZN9ednatoken8transferEyyN5eosio5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE $_ZN9ednatoken5issueEyN5eosio5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE $_ZN9ednatoken7processEh $_ZN9ednatoken7unstakeEy $_ZN9ednatoken5stakeEyhN5eosio5assetE $_ZN9ednatoken6createEyN5eosio5assetE)
 (memory $0 1)
 ...
 (data (i32.const 160) "now ()      : \00")
 (data (i32.const 176) "\n\00")
 (data (i32.const 192) "attempt to add asset with different symbol\00")
 (data (i32.const 240) "addition underflow\00")
 (data (i32.const 272) "addition overflow\00")
 (data (i32.const 304) "cannot increment end iterator\00")
 (data (i32.const 336) "Weekly Base         : \00")
 (data (i32.const 368) "Total Stake         : \00")
 (data (i32.const 400) "Supplied Token      : \00")
 (data (i32.const 432) "Total Shares        : \00")
 (data (i32.const 464) "Perc Stakedx100     : \00")
 ...
 (data (i32.const 608) "Base Payout         : \00")
 ...
 (data (i32.const 944) "Total Payout        : \00")
 ...
 (data (i32.const 1088) "Unclaimed Tokens    : \00")
 (data (i32.const 1120) "Unclaimed Tokens\00")
 (data (i32.const 1152) "Stakes processed, total_payout == 0, nothing to pay.\n\00")
 (data (i32.const 1216) "PAYOUT  : \00")
 (data (i32.const 1232) "------  Reward  ---------------\n\00")
 (data (i32.const 1280) "TO      : \00")
 ...
 (data (i32.const 1856) "invalid quantity\00")
 (data (i32.const 1888) "must transfer positive quantity\00")
 (data (i32.const 1920) "symbol precision mismatch\00")
 (data (i32.const 1952) "Invalid stake period.\00")
 (data (i32.const 1984) "Account already has a stake. Must unstake first.\00")
 (data (i32.const 2048) "get\00")
 (data (i32.const 2064) "cannot transfer to self\00")
 (data (i32.const 2096) "memo has more than 256 bytes\00")
 (data (i32.const 2128) "stake with symbol does not exist, create stake before issue\00")
 (data (i32.const 2192) "must issue positive quantity\00")
 (data (i32.const 2224) "quantity exceeds available supply\00")
 (data (i32.const 2272) "active\00")
 (data (i32.const 2288) "invalid supply\00")
 (data (i32.const 2304) "max-supply must be positive\00")
 (data (i32.const 2336) "stake with symbol already exists\00")
 ...
 (export "_ZN9ednatoken7processEh" (func $_ZN9ednatoken7processEh))
 ...
 (func $_ZN9ednatoken7processEh (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i64)
  (local $5 i64)
      ...
      (block $label$28
       ...
       (loop $label$33
        ...
        (block $label$38
         ...
         (call $_ZN5eosio11multi_indexILy14289083102591451136EN9ednatoken9stake_rowEJEE6modifyIZNS1_7processEhE3$_7EEvRKS2_yOT_
          (i32.add
           (get_local $12)
           (i32.const 224)
          )
 ...
 (func $_ZN5eosio11multi_indexILy14289083102591451136EN9ednatoken9stake_rowEJEE6modifyIZNS1_7processEhE3$_7EEvRKS2_yOT_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i64)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
